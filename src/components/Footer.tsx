  ...
  return (
    <footer className="bg-[#0A2A3D]   text-white py-10 px-6 md:px-20 mt-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {/* SERVICES */}
        <div>
          <h3 className="text-yellow-500 font-semibold mb-3">NOS SERVICES</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            <li className="flex">
              <MapPinned /> <p className="ml-1">123 Rue des Artisans, Paris</p>
            </li>
            <li className="flex">
              {" "}
              <Phone />
              <p className="ml-1">01 23 45 67 89</p>
            </li>
            <li className="flex">
              {" "}
              <Mail /> <p className="ml-1">contact@maxlines-plomberie.fr</p>
            </li>
            <li className="flex">
              <Clock10 />
              <p className="ml-1"> Lundi - Vendredi : 8h - 18h</p>
            </li>
          </ul>

          <h3 className="text-yellow-500 font-semibold mt-6 mb-3">
            LIENS UTILES
          </h3>
          <ul className="space-y-2 text-gray-300">
            {[
