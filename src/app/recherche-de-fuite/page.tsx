...
export default function page() {
  return (
    <>
      <Menu />
      <Banner
        name="/page-recherche-fuite/fuites-2.webp"
        alt="Image recherchant une fuite"
        title="Recherche de fuite"
        text="Nos experts localisent rapidement les fuites grâce à des technologies avancées. Protégez vos installations et évitez des dégâts coûteux en nous faisant confiance pour un diagnostic précis et rapide."
      />
